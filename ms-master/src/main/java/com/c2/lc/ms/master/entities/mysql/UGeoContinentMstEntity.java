...
@Entity
@Table(name = "u_geo_continent_mst")
public class UGeoContinentMstEntity {
    ...
    public boolean equals(Object o) {
        ...
        UGeoContinentMstEntity that = (UGeoContinentMstEntity) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(cCode, cName, cShName, cGeoLat, cGeoLon, nAudited, nPredefined, cCreateuser, dAdate, dLdate, tLtime, cModiuser);
    }
}
