...
public interface SearchTransaction extends MasterBaseTransaction {
    ...
    JsonArray getItemListByCategory(LcHeaderBO headerBO, SearchBO searchBO) throws RecordNotFoundException;
    ...
    long countMolecules(SearchBO searchBO);
    ...
    long getSellerOnProductCount(LcHeaderBO lcHeaderBO, SearchBO searchBO, String sellerCode) throws CommunicationErrorException, InvalidRequestException, RecordNotFoundException;

    JsonArray getMolecules(LcHeaderBO header, SearchBO searchBO) throws RecordNotFoundException;

    JsonArray getProducts(Long userId, SearchBO searchBO, String c2Code) throws RecordNotFoundException;
