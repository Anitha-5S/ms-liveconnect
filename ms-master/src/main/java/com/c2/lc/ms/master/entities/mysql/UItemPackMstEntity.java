...
@Entity
@Table(name = "u_item_pack_mst")
public class UItemPackMstEntity {
    ...
    @Basic
    @Column(name = "n_qty_per_box", nullable = false, precision = 0)
    public int getnQtyPerBox() {
        return nQtyPerBox;
    }

    public void setnQtyPerBox(int nQtyPerBox) {
    ...
    public boolean equals(Object o) {
        ...
        UItemPackMstEntity that = (UItemPackMstEntity) o;
        return nQtyPerBox == that.nQtyPerBox &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(cCode, cName, cShName, nQtyPerBox, nAudited, nPredefined, cCreateuser, dAdate, dLdate, tLtime, cModiuser);
    }
}
