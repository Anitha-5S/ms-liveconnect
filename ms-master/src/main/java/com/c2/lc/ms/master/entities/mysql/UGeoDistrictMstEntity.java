...
@Entity
@Table(name = "u_geo_district_mst")
public class UGeoDistrictMstEntity {
    private String cCode;
    private String cName;
    private String cShName;
    private String cGeoStateCode;
    ...
    @Basic
    @Column(name = "c_geo_state_code", nullable = false, length = 6)
    public String getcGeoStateCode() {
        return cGeoStateCode;
    }

    public void setcGeoStateCode(String cGeoStateCode) {
        this.cGeoStateCode = cGeoStateCode;
    }
    ...
    public boolean equals(Object o) {
        ...
        UGeoDistrictMstEntity that = (UGeoDistrictMstEntity) o;
        return Objects.equals(cCode, that.cCode) &&
                Objects.equals(cName, that.cName) &&
                Objects.equals(cShName, that.cShName) &&
                Objects.equals(cGeoStateCode, that.cGeoStateCode) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(cCode, cName, cShName, cGeoStateCode, cGeoLat, cGeoLon, nAudited, nPredefined, cCreateuser, dAdate, dLdate, tLtime, cModiuser);
    }
}
