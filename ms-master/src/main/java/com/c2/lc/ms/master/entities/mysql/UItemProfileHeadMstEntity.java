...
@Entity
@Table(name = "u_item_profile_head_mst")
public class UItemProfileHeadMstEntity {
    ...
    public boolean equals(Object o) {
        ...
        UItemProfileHeadMstEntity that = (UItemProfileHeadMstEntity) o;
    ...
    @Override
    public int hashCode() {
        int result = Objects.hash(cCode, cName, cShName, nAudited, nPredefined, cCreateuser, dAdate, dLdate, cModiuser);
