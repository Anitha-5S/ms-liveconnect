...
@Entity
@Table(name = "u_item_profile_mst")
public class UItemProfileMstEntity {
    private String cCode;
    private String cName;
    private String cShName;
    private String cItemProfileHeadCode;
    ...
    @Basic
    @Column(name = "c_item_profile_head_code", nullable = false, length = 6)
    public String getcItemProfileHeadCode() {
        return cItemProfileHeadCode;
    }

    public void setcItemProfileHeadCode(String cItemProfileHeadCode) {
        this.cItemProfileHeadCode = cItemProfileHeadCode;
    }
    ...
    public boolean equals(Object o) {
        ...
        UItemProfileMstEntity that = (UItemProfileMstEntity) o;
        return Objects.equals(cCode, that.cCode) &&
                Objects.equals(cName, that.cName) &&
                Objects.equals(cShName, that.cShName) &&
                Objects.equals(cItemProfileHeadCode, that.cItemProfileHeadCode) &&
    ...
    @Override
    public int hashCode() {
        int result = Objects.hash(cCode, cName, cShName, cItemProfileHeadCode, nAudited, nPredefined, cCreateuser, dAdate, dLdate, cModiuser);
