...
@Entity
@Table(name = "u_geo_country_mst")
public class UGeoCountryMstEntity {
    private String cCode;
    private String cName;
    private String cShName;
    private String cGeoContinentCode;
    ...
    @Basic
    @Column(name = "c_geo_continent_code", nullable = false, length = 6)
    public String getcGeoContinentCode() {
        return cGeoContinentCode;
    }

    public void setcGeoContinentCode(String cGeoContinentCode) {
        this.cGeoContinentCode = cGeoContinentCode;
    }
    ...
    public boolean equals(Object o) {
        ...
        UGeoCountryMstEntity that = (UGeoCountryMstEntity) o;
        return Objects.equals(cCode, that.cCode) &&
                Objects.equals(cName, that.cName) &&
                Objects.equals(cShName, that.cShName) &&
                Objects.equals(cGeoContinentCode, that.cGeoContinentCode) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(cCode, cName, cShName, cGeoContinentCode, cGeoLat, cGeoLon, nAudited, nPredefined, cCreateuser, dAdate, dLdate, tLtime, cModiuser);
    }
}
