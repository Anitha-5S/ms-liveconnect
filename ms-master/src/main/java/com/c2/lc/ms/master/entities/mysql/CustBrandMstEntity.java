...
@Entity
@Table(name = "cust_brand_mst")
@IdClass(CustBrandMstEntityPK.class)
public class CustBrandMstEntity {
    ...
    @Column(name = "c_name", nullable = true, length = 250)
    ...
    @Column(name = "c_modiuser", nullable = true, length = 6)
    ...
    public boolean equals(Object o) {
        ...
        CustBrandMstEntity that = (CustBrandMstEntity) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(cC2code, cCode, cName, cShName, dLdate, dAdate, cCreateuser, nAudited, nPredefined, tLtime, cModiuser);
    }
}
