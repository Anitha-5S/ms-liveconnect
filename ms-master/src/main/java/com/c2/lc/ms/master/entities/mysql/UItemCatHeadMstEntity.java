...
@Entity
@Table(name = "u_item_cat_head_mst")
public class UItemCatHeadMstEntity {
    private String cCode;
    private String cName;
    private String cShName;
    private String cItemCategoryClassCode;
    ...
    @Basic
    @Column(name = "c_item_category_class_code", nullable = false, length = 6)
    public String getcItemCategoryClassCode() {
        return cItemCategoryClassCode;
    }

    public void setcItemCategoryClassCode(String cItemCategoryClassCode) {
        this.cItemCategoryClassCode = cItemCategoryClassCode;
    }
    ...
    public boolean equals(Object o) {
        ...
        UItemCatHeadMstEntity that = (UItemCatHeadMstEntity) o;
        return Objects.equals(cCode, that.cCode) &&
                Objects.equals(cName, that.cName) &&
                Objects.equals(cShName, that.cShName) &&
                Objects.equals(cItemCategoryClassCode, that.cItemCategoryClassCode) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(cCode, cName, cShName, cItemCategoryClassCode, nAudited, nPredefined, cCreateuser, dAdate, dLdate, tLtime, cModiuser);
    }
}
