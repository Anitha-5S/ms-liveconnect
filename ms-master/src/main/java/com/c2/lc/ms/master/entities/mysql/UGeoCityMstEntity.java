...
@Entity
@Table(name = "u_geo_city_mst")
public class UGeoCityMstEntity {
    private String cCode;
    private String cName;
    private String cShName;
    private String cGeoDistrictCode;
    ...
    @Basic
    @Column(name = "c_geo_district_code", nullable = false, length = 6)
    public String getcGeoDistrictCode() {
        return cGeoDistrictCode;
    }

    public void setcGeoDistrictCode(String cGeoDistrictCode) {
        this.cGeoDistrictCode = cGeoDistrictCode;
    }
    ...
    public boolean equals(Object o) {
        ...
        UGeoCityMstEntity that = (UGeoCityMstEntity) o;
        return Objects.equals(cCode, that.cCode) &&
                Objects.equals(cName, that.cName) &&
                Objects.equals(cShName, that.cShName) &&
                Objects.equals(cGeoDistrictCode, that.cGeoDistrictCode) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(cCode, cName, cShName, cGeoDistrictCode, cGeoLat, cGeoLon, nAudited, nPredefined, cCreateuser, dAdate, dLdate, tLtime, cModiuser);
    }
}
