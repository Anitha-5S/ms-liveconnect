...
@Entity
@Table(name = "u_geo_state_mst")
public class UGeoStateMstEntity implements Serializable {

    private static final long serialVersionUID = 8360099781218098731L;
    private String cCode;
    private String cName;
    private String cShName;
    private String cGeoZoneCode;
    ...
    @Basic
    @Column(name = "c_geo_zone_code", nullable = false, length = 6)
    public String getcGeoZoneCode() {
        return cGeoZoneCode;
    }

    public void setcGeoZoneCode(String cGeoZoneCode) {
        this.cGeoZoneCode = cGeoZoneCode;
    }
    ...
    public boolean equals(Object o) {
        ...
        UGeoStateMstEntity that = (UGeoStateMstEntity) o;
        return Objects.equals(cCode, that.cCode) &&
                Objects.equals(cName, that.cName) &&
                Objects.equals(cShName, that.cShName) &&
                Objects.equals(cGeoZoneCode, that.cGeoZoneCode) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(cCode, cName, cShName, cGeoZoneCode, cGeoLat, cGeoLon, nAudited, nPredefined, cCreateuser, dAdate, dLdate, tLtime, cModiuser);
    }
}
