...
@Entity
@Table(name = "u_geo_zone_mst")
public class UGeoZoneMstEntity {
    private String cCode;
    private String cName;
    private String cShName;
    private String cGeoCountryCode;
    ...
    @Basic
    @Column(name = "c_geo_country_code", nullable = false, length = 6)
    public String getcGeoCountryCode() {
        return cGeoCountryCode;
    }

    public void setcGeoCountryCode(String cGeoCountryCode) {
        this.cGeoCountryCode = cGeoCountryCode;
    }
    ...
    public boolean equals(Object o) {
        ...
        UGeoZoneMstEntity that = (UGeoZoneMstEntity) o;
        return Objects.equals(cCode, that.cCode) &&
                Objects.equals(cName, that.cName) &&
                Objects.equals(cShName, that.cShName) &&
                Objects.equals(cGeoCountryCode, that.cGeoCountryCode) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(cCode, cName, cShName, cGeoCountryCode, cGeoLat, cGeoLon, nAudited, nPredefined, cCreateuser, dAdate, dLdate, tLtime, cModiuser);
    }
}
