...
@Entity
@Table(name = "u_item_storage_mst")
public class UItemStorageMstEntity {
    ...
    public boolean equals(Object o) {
        ...
        UItemStorageMstEntity that = (UItemStorageMstEntity) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(cCode, cName, cShName, cMessage, nAudited, nPredefined, cCreateuser, dAdate, dLdate, tLtime, cModiuser);
    }
}
